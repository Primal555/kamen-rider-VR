...
clean_fbx_path = r"E:\unity projects\KamenRider\Assets\Characters\MinamiKotaro\Models\kotarotest_clean_applied.fbx"
...
target_mesh.data.transform(target_mesh.matrix_world)
target_mesh.matrix_world.identity()
